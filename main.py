...
class InterventionSorterApp (tk .Tk ):
    ...
    checkpoint_name :str ,
        ...
        bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,font =theme.FONT_BOLD ,
        ...
        for tab_name ,filename in groups :
            ...
            variable =var ,
            bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,font =theme.FONT_BOLD ,
            activebackground =theme.PANEL_BG ,selectcolor ="white",
            cursor ="hand2",
            ).pack (side ="left")
            tk .Label (row ,text =f"({filename })",
            bg =theme.PANEL_BG ,fg =theme.TEXT_MUTED ,font =theme.FONT_SUB ).pack (side ="left")
        ...
        bg =theme.PANEL_BG ,fg =theme.TEXT_MUTED ,font =theme.FONT_SUB ).pack (padx =20 ,anchor ="w")
    ...
    def _ensure_season_set (self )->bool :
        ...
        # Season name field
        f1 =tk .Frame (dialog ,bg =theme.PANEL_BG )
        f1 .pack (fill ="x",padx =24 ,pady =(16 ,6 ))
        tk .Label (f1 ,text ="Season Name:",bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,
        font =theme.FONT_MAIN ,width =16 ,anchor ="w").pack (side ="left")
        season_var =tk .StringVar (value =season or "")
        tk .Entry (f1 ,textvariable =season_var ,font =theme.FONT_MAIN ,width =28 ,
        relief ="flat",bg ="white",
        highlightthickness =1 ,highlightbackground ="#B0BEC5",
        insertbackground =theme.TEXT_FG ).pack (side ="left",ipady =4 )

        # Checkpoint type
        from utils .config import CHECKPOINT_TYPES 
        f2 =tk .Frame (dialog ,bg =theme.PANEL_BG )
        f2 .pack (fill ="x",padx =24 ,pady =(0 ,16 ))
        tk .Label (f2 ,text ="Checkpoint:",bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,
        font =theme.FONT_MAIN ,width =16 ,anchor ="w").pack (side ="left")
        ...
        def on_proceed ():
            ...
            if not s :
                ...
                bg =theme.PANEL_BG ,fg ="#C62828",font =theme.FONT_SUB ).pack ()
                return 
    ...
    def _show_new_semester_dialog (self ,on_startup :bool =False ):
        ...
        tk .Label (dialog ,text =msg ,bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,
        font =theme.FONT_BOLD ,wraplength =400 ).pack (pady =(24 ,4 ),padx =24 ,anchor ="w")
        tk .Label (dialog ,text ="All runs this semester will be organized together.",
        bg =theme.PANEL_BG ,fg =theme.TEXT_MUTED ,font =theme.FONT_SUB ).pack (padx =24 ,anchor ="w")

        f =tk .Frame (dialog ,bg =theme.PANEL_BG )
        f .pack (fill ="x",padx =24 ,pady =(20 ,0 ))
        tk .Label (f ,text ="Semester Name:",bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,
        font =theme.FONT_MAIN ,width =16 ,anchor ="w").pack (side ="left")
        name_var =tk .StringVar (value ="")
        entry =tk .Entry (f ,textvariable =name_var ,font =theme.FONT_BOLD ,width =26 ,
        relief ="flat",bg ="white",
        highlightthickness =1 ,highlightbackground ="#B0BEC5",
        ...
        err_lbl =tk .Label (dialog ,text ="",bg =theme.PANEL_BG ,fg ="#C62828",font =theme.FONT_SUB )
